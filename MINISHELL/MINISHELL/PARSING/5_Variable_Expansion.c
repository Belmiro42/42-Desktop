...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   5_Variable_Expansion.c                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: bmatos-d <bmatos-d@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/21 20:51:50 by bmatos-d          #+#    #+#             */
/*   Updated: 2024/07/27 09:54:21 by bmatos-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char *get_var_value(int *iterator, char *input, int *quote)
{
	...
	while (count < 65 && (c == 95 || (47 < c && c < 58) || (64 < c && c < 92) || (96 < c && c < 123)) && !(count == 0 && 47 < c && c < 58))
	{
...
void evaluate_var(char *input, char **output, int *quote)
{
	...
	while (input[iterator])
	{
		...
		if (input[iterator] == '$' && *quote != 1 && input[iterator + 1] != '\0' && input[iterator + 1] != ' ')
		{
